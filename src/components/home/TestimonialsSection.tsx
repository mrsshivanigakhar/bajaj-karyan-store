...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      'We have been buying our monthly rations from Bajaj Karyan for over 15 years. Now building our shopping list with custom weights online has made everything effortless.',
  ...
  },
  {
    ...
    quote:
      'Finding 250g and 500g spice packs online is impossible elsewhere. Bajaj Karyan packs exactly what I ask for, and market-rate pricing is totally honest and transparent.',
...
export function TestimonialsSection() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-6">
      <div className="rounded-3xl bg-gradient-to-br from-rose-50/90 via-pink-50/40 to-amber-50/40 border border-rose-100 p-8 sm:p-12 shadow-xs">
        {/* Section Header */}
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-sm text-gray-600 mt-2">
            Real experiences from Firozpur households who rely on Bajaj Karyan Store for their daily groceries and celebrations.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((item) => (
            <div
              key={item.id}
              className="flex flex-col justify-between bg-white rounded-2xl p-6 border border-rose-100/80 shadow-xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 relative group"
            >
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Quote className="w-6 h-6 text-rose-200 group-hover:text-rose-300 transition-colors" />
                </div>
              ...
              {/* Reviewer Details */}
              <div className="pt-4 mt-4 border-t border-rose-50 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#800f2f] to-[#ff4d6d] text-white flex items-center justify-center font-bold text-xs shadow-xs shrink-0">
                  {item.initials}
                </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[11px] text-gray-500 truncate">{item.location}</p>
                  <span className="inline-block mt-1 text-[10px] font-medium bg-rose-50 text-[#800f2f] px-2 py-0.5 rounded-md">
                    {item.tag}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-8 pt-6 border-t border-rose-200/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-600">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">100% Satisfaction Guarantee on Every Delivery</span>
          </div>
